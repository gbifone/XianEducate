...
/**
 * @author WinChen
 * @date 2014-4-2 上午9:55:58
 * @version 1.01
 */
/**
 * @author WinChen
 * @date 2014-4-3 上午11:24:19
 * @version 1.02
 * @event 1. add read and write private file.contains directory
 *        "/data/data/(my package)/file" 、 "raw" or "assert" etc. 2. add
 *        function of copy and move.
 */
public class FileUtils
{
	...
	public boolean assetsCopyData(String strAssetsFilePath, String strDesFilePath)
	{
		...
		try
		{
			inputStream = ApplicationContext.mContext.getAssets()
